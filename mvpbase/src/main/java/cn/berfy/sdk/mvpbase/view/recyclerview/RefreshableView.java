...
public class RefreshableView extends LinearLayout {
    ...
    private void init() {
        ...
        LayoutParams animLayoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        animLayoutParams.gravity = Gravity.BOTTOM | Gravity.CENTER;
        layout_anim.addView(mAnimView, animLayoutParams);
        // 下拉显示text
...
//        mCircleView.stopAnim();
        mAnimView.stopAnim(SCROLL_DURATION);
