...
public class AppShortCutUtil {
    ...
    public void addNumShortCut(Class<?> clazz, String appName, int iconResId, boolean isShowNum, int num) {
        SharedPreferenceUtils.put(mContext, CacheConstant.XML_MESSAGE_UNREAD_NUM_FOR_MIUI, num);
...
//        ids.add("custom_id_2");
    ...
    public void deleteShortCut(String appName, Class<?> clazz) {
        ...
        SharedPreferenceUtils.put(mContext, CacheConstant.XML_MESSAGE_UNREAD_NUM_FOR_MIUI, 0);
        if (Build.MANUFACTURER.equalsIgnoreCase("Xiaomi")) {
            //小米
            //当为""时，不显示数字，相当于隐藏了)
